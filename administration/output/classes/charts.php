...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("surat_masuk" == $this->chrt_array['tables'][0])
			return true;
		if("user" == $this->chrt_array['tables'][0])
			return true;
		if("administrationugrights" == $this->chrt_array['tables'][0])
			return true;
		if("administrationugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("user" == $this->chrt_array['tables'][0])
			return true;
		if("student" == $this->chrt_array['tables'][0])
			return true;
		if("subject" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
