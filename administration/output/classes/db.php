...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "db_administration_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "administrationuggroups", "varname" => "db_administration_at_localhost__administrationuggroups", "altvarname" => "administrationuggroups", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
			$dalTables[$conn->connId][] = array("name" => "administrationugmembers", "varname" => "db_administration_at_localhost__administrationugmembers", "altvarname" => "administrationugmembers", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
			$dalTables[$conn->connId][] = array("name" => "administrationugrights", "varname" => "db_administration_at_localhost__administrationugrights", "altvarname" => "administrationugrights", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
			$dalTables[$conn->connId][] = array("name" => "student", "varname" => "db_administration_at_localhost__student", "altvarname" => "student", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
			$dalTables[$conn->connId][] = array("name" => "subject", "varname" => "db_administration_at_localhost__subject", "altvarname" => "subject", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
			$dalTables[$conn->connId][] = array("name" => "surat_masuk", "varname" => "db_administration_at_localhost__surat_masuk", "altvarname" => "surat_masuk", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
			$dalTables[$conn->connId][] = array("name" => "user", "varname" => "db_administration_at_localhost__user", "altvarname" => "user", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
		}
	}
