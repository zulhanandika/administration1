...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "surat_masuk" ] = array( "url" => "surat_masuk", "type" => 0 );
	$projectEntitiesReverse[ "surat_masuk" ] = "surat_masuk";
	...
	$projectEntities[ "student" ] = array( "url" => "student", "type" => 0 );
	$projectEntitiesReverse[ "student" ] = "student";
	$projectEntities[ "subject" ] = array( "url" => "subject", "type" => 0 );
	$projectEntitiesReverse[ "subject" ] = "subject";
}
