...
$nonAdminTablesArr[] = "surat_masuk";
$nonAdminTablesArr[] = "user";
$nonAdminTablesArr[] = "student";
$nonAdminTablesArr[] = "subject";
...
$wGroupTableName = $ug_connection->addTableWrappers( "administrationuggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "administrationugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "administrationugrights" );
