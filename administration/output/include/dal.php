...
class tDAL
{
	var $tbldb_administration_at_localhost__administrationuggroups;
	var $tbldb_administration_at_localhost__administrationugmembers;
	var $tbldb_administration_at_localhost__administrationugrights;
	var $tbldb_administration_at_localhost__student;
	var $tbldb_administration_at_localhost__subject;
	var $tbldb_administration_at_localhost__surat_masuk;
	var $tbldb_administration_at_localhost__user;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "administrationuggroups", "varname" => "db_administration_at_localhost__administrationuggroups", "altvarname" => "administrationuggroups", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
		$this->lstTables[] = array("name" => "administrationugmembers", "varname" => "db_administration_at_localhost__administrationugmembers", "altvarname" => "administrationugmembers", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
		$this->lstTables[] = array("name" => "administrationugrights", "varname" => "db_administration_at_localhost__administrationugrights", "altvarname" => "administrationugrights", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
		$this->lstTables[] = array("name" => "student", "varname" => "db_administration_at_localhost__student", "altvarname" => "student", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
		$this->lstTables[] = array("name" => "subject", "varname" => "db_administration_at_localhost__subject", "altvarname" => "subject", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
		$this->lstTables[] = array("name" => "surat_masuk", "varname" => "db_administration_at_localhost__surat_masuk", "altvarname" => "surat_masuk", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
		$this->lstTables[] = array("name" => "user", "varname" => "db_administration_at_localhost__user", "altvarname" => "user", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
	}
