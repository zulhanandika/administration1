...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "db_administration_at_localhost" );
	}
	...
	{
		return "db_administration_at_localhost";
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["surat_masuk"] = "db_administration_at_localhost";
		$connectionsIds["user"] = "db_administration_at_localhost";
		$connectionsIds["admin_rights"] = "db_administration_at_localhost";
		$connectionsIds["admin_members"] = "db_administration_at_localhost";
		$connectionsIds["admin_users"] = "db_administration_at_localhost";
		$connectionsIds["student"] = "db_administration_at_localhost";
		$connectionsIds["subject"] = "db_administration_at_localhost";
